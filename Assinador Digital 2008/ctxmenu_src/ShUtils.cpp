...
//
////////////////////////////////////////////////////////////////////////
STDMETHODIMP CreateShellExtMenuBmpArray(HMENU hMenu,
                                         UINT indexMenu,
                                         UINT idCmdFirst,
                                         UINT idCmdLast,
                                         UINT uFlags,
   ...
   if (bAppendItems)
   {
      ...
      if (hParentMenu) 
      {
         ...
         {        
            ...
            SetMenuItemBitmaps(hMenu, indexMenu-1, MF_BITMAP | MF_BYPOSITION, hbmp[0], hbmp[0]);
         }
         
        

         InsertMenu(hParentMenu, indexMenu++, MF_STRING|MF_BYPOSITION, idCmd++, "Assinar...");
         SetMenuItemBitmaps(hParentMenu, 0, MF_BITMAP | MF_BYPOSITION, hbmp[1],hbmp[1]);
         InsertMenu(hParentMenu, indexMenu++, MF_STRING|MF_BYPOSITION, idCmd++, "Remover Assinatura(s)");
         SetMenuItemBitmaps(hParentMenu, 1, MF_BITMAP | MF_BYPOSITION, hbmp[2], hbmp[2]);
		 InsertMenu(hParentMenu, indexMenu++, MF_STRING|MF_BYPOSITION, idCmd++, "Visualizar Assinatura(s)");
         SetMenuItemBitmaps(hParentMenu, 2, MF_BITMAP | MF_BYPOSITION, hbmp[3], hbmp[3]);
      }
                                         ...
                                         HBITMAP hbmp)
{
   ...
   if (bAppendItems)
   {
      ...
      if (hParentMenu) 
      {
         ...
         InsertMenu(hParentMenu, indexMenu++, MF_STRING|MF_BYPOSITION, idCmd++, "Assinar...");
         SetMenuItemBitmaps(hParentMenu, 0, MF_BITMAP | MF_BYPOSITION, hbmp,hbmp);
         InsertMenu(hParentMenu, indexMenu++, MF_STRING|MF_BYPOSITION, idCmd++, "Remover Assinatura(s)");
         SetMenuItemBitmaps(hParentMenu, 1, MF_BITMAP | MF_BYPOSITION, hbmp, hbmp);
      }
