...
{
    public partial class frmSelectDigitalSignatureToRemove : Form
    {
        #region Constructor
        /// <summary>
        /// Constructor
        /// </summary>
        public frmSelectDigitalSignatureToRemove(string[] paths, bool subfolders)
        {
            InitializeComponent();
            documents = paths;
        ...
        private void frmRemoveDigitalSignature_Load(object sender, EventArgs e)
        {
