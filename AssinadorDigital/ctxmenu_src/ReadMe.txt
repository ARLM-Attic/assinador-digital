...
General Info
------------
  CtxMenu demonstrates a simple Explorer context menu extension. This allows
...
-----------------------
  Each time you build this DLL, or when you call regsvr32.exe /s /c CtxMenu.dll,
...
is "regsvr32.exe /s /c $(OUTDIR)\CtxMenu.dll". If this doesn't happen, you will
...
------------------
  Thread info
  -----------
  CtxMenu uses threads. Because data is being used by all threads, a 
...
------------------------------------------------------------------------------
CtxMenu.h         - You will need to insert your DEFINE_GUID(...) code here
                    before you release your extension.

CtxMenu.cpp       - Contains the basic CWinApp code and some required COM
...
ShellCtxMenu.cpp  - This contains the three routines that control menu text,
