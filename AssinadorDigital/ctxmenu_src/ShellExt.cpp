...
CShellExt::CShellExt()
{
   ...
   m_menuBmp.LoadBitmap(IDB_BITMAP2);
   m_submenuBmp1.LoadBitmap(IDB_BITMAP5);
   m_submenuBmp2.LoadBitmap(IDB_BITMAP4);
   m_submenuBmp3.LoadBitmap(IDB_BITMAP2);
}
...
CShellExt::~CShellExt()
{
   ...
   if (m_submenuBmp1.GetSafeHandle())
      m_submenuBmp1.DeleteObject();
   if (m_submenuBmp2.GetSafeHandle())
      m_submenuBmp2.DeleteObject();
   if (m_submenuBmp3.GetSafeHandle())
      m_submenuBmp3.DeleteObject();
}
