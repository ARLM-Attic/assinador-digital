...
#define	SHELLEXNAME				"Assinador Digital"
...
extern STDMETHODIMP CreateShellExtMenuBmpArray(HMENU hMenu, UINT indexMenu, UINT idCmdFirst, UINT idCmdLast, UINT uFlags, HBITMAP* hbmp);
